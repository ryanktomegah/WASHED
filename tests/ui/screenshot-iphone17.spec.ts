...
test('capture all 9 onboarding screens at iPhone 15/16/17 (393×852)', async ({ page }) => {
  ...
  await page.screenshot({ path: 'screenshots/x03i-identity-iphone17.png', fullPage: true });
